...
export const register = async (req, res,next) => {
   ...
   try {
    ...
    if (user) return next(new ErrorHandler("User Alredy Exists",400));
...
export const login = async (req, res,next) => {
    ...
    if (!isMatch)   return next(new ErrorHandler("Invalid Email or Passowrd",400));
...
// get user details   auth middleware is used in this
